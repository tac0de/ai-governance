...
- This file only narrows execution for `services/obsidian-mcp`.
...
- Preserve read-only vault access contracts unless high-tier override is approved.
- Do not execute direct runtime implementation changes inside `ai-governance`.
